...
The Cold Regions Hydrological Modelling Platform (CRHM) was implemented to simulate SWE at each of the four forest plots. The CRHM platform is described in detail in @Pomeroy2022; and the up-to-date source code is available at https://github.com/srlabUsask/crhmcode. Hourly climate forcing data from station-based measurements of air temperature, relative humidity, wind speed, total precipitation, and above canopy incoming solar radiation were used to run the CRHM models. Incoming solar radiation observations were not available for Wolf Creek and were simulated following theoretical clear-sky radiation by @Garnier1970 and atmospheric transmittance by @Annandale2002 and @Shook2011. 
